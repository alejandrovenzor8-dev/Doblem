...
export const properties: Property[] = [
  ...
  },
  {
    ...
    area: 273,
    description:
      "Residencia contemporánea de lujo en Asturias Residencial, con 220.50 m² de terreno y 273.58 m² de construcción. La arquitectura contemporánea, la funcionalidad y los acabados premium se unen para ofrecer un estilo de vida excepcional. Ubicada en una de las zonas con mayor plusvalía y crecimiento residencial de la ciudad, es ideal para quienes buscan invertir en patrimonio, comodidad y exclusividad.",
    features: [
      "3 amplias recámaras",
      "Recámara principal con baño completo, amplio vestidor y balcón privado",
      "2 recámaras secundarias con vestidor independiente cada una",
      "Espacios diseñados para brindar privacidad y confort",
      "Cocina de diseño integrada al comedor, con distribución amplia y funcional",
      "Estancia familiar en planta alta",
      "Cochera para 2 vehículos",
      "Iluminación arquitectónica que crea una atmósfera cálida y sofisticada",
    ],
    amenities: [
      "Balcón privado",
      "Vestidores",
  ...
  },
  {
    ...
    area: 315,
    description:
      "Residencia contemporánea de lujo en preventa, con 275 m² de terreno y 315.65 m² de construcción. Arquitectura contemporánea, acabados premium y espacios diseñados para vivir con elegancia.",
    features: [
      "4 recámaras, todas con baño completo",
      "Impresionante doble altura",
